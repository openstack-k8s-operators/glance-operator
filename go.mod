...
require (
	...
	k8s.io/apiextensions-apiserver v0.26.1 // indirect // indirect
	k8s.io/component-base v0.26.1 // indirect // indirect
	k8s.io/klog/v2 v2.80.1 // indirect
	k8s.io/kube-openapi 76d406abb92a // indirect // indirect
	k8s.io/utils 391b47cb4029 // indirect // indirect
	sigs.k8s.io/json bc3834ca7abd // indirect // indirect
