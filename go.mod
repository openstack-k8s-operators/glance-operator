...
require (
	...
	github.com/openstack-k8s-operators/infra-operator/apis v0.6.1-0.20250429094017-e29645f53d1e
	github.com/openstack-k8s-operators/keystone-operator/api v0.6.1-0.20250429093135-2d80dc35699b
