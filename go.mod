...
require (
	...
	github.com/openstack-k8s-operators/cinder-operator/api v0.4.1-0.20240723072813-3154269be479
	...
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.4.1-0.20240722053056-bd202c880706
