...
require (
	...
	github.com/openstack-k8s-operators/cinder-operator/api v0.3.1-0.20240213172304-98dedddf41d2
	...
	github.com/openstack-k8s-operators/mariadb-operator/api v0.3.1-0.20240212090924-d9f41ad6f84a
	k8s.io/api v0.26.13
