...
ARG IMAGE_COMPONENT="glance-operator-container"
ARG IMAGE_NAME="glance-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Glance Operator"
ARG IMAGE_DESC="This image includes the glance-operator"
