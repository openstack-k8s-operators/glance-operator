...
// Package main implements the entry point for the glance-operator manager.
package main
...
import (
	...
	webhookv1beta1 "github.com/openstack-k8s-operators/glance-operator/internal/webhook/v1beta1"
...
func main() {
	...
	if err := (&controller.GlanceAPIReconciler{
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1beta1.SetupGlanceAPIWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "GlanceAPI")
			os.Exit(1)
		}

		if err := webhookv1beta1.SetupGlanceWebhookWithManager(mgr); err != nil {
